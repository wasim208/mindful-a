...
const SignupUser = ({ navigation, check }) => {
    ...
    <Screen>
      <View style={styles.signupPage}>
        ...
        <View style={styles.signupForm}>
          ...
          {/* <Text style = {styles.bottomtxt}>Are you a counsellor?</Text><TouchableOpacity 
                style = {styles.signuplink}
                onPress = {() => navigation.navigate('SignupCon')}>
                <Text style = {styles.bottomtxtl}>Click here to Signup</Text></TouchableOpacity> */}
        </View>
      </View>
    </Screen>
  );
